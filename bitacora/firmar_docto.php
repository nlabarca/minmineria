...
$sql_adj1="select docto_adjunto from bitacora_mensual where folio_bitacora=$id";
$rs_adj1 = mssql_query ($sql_adj1,$connection);	
$row_adj1=mssql_fetch_array($rs_adj1);
$archivo1=$row_adj1['docto_adjunto'];
