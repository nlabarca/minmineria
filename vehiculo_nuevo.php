                      ...
                      <div class="col-md-6">
                        <div class="form-group">
						  <label class="bmd-label-static">N&deg; Motor (*)</label>
                           <input name="txt_nmotor" type="text" class="form-control" id="txt_nmotor" required="true" aria-invalid="true" aria-required="true">
						</div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-static">N&deg; Chasis (*)</label>
                          <input name="txt_chasis" type="text" class="form-control" id="txt_chasis" required="true" aria-invalid="true" aria-required="true">
						</div>
                      </div>
   ...
   function setFormValidation(id) {
	...
	function showNotification(from, align, ms){
		if(ms==1){ 
			$.notify({
				icon: "check_circle",
				message: "El veh&iacute;culo se ha registrado exitosamente!"
			},{
				type:'success',
				timer: 3000,
				placement: {
	 	...
	 	if(ms==2){ 
			$.notify({
				icon: "cancel",
				message: "Ya se encuentra registrado un veh&iacute;culo con esa patente!"
			},{
				type:'danger',
				timer: 3000,
				placement: {
