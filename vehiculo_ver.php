      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#">Ver Veh&iacute;culo</a>
          </div>
          ...
          <div class="row">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group bmd-form-group">
							<label class="bmd-label-static">Tipo Veh&iacute;culo (*)</label>
						 	<select name="sel_tipo_vehiculo" class="form-control" id="sel_tipo_vehiculo" required="true" aria-invalid="true" aria-required="true" disabled>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input name="txt_marca" type="text" class="form-control" id="txt_marca" required="true" aria-invalid="true" aria-required="true" value="<?php echo $datos['marca'];?>" readonly>
						</div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                           ...
                           <input name="txt_modelo" type="text" class="form-control" id="txt_modelo" required="true" aria-invalid="true" aria-required="true" value="<?php echo $datos['modelo'];?>" readonly>
						</div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-static">Año (*)</label>
                          <input name="txt_anio" type="text" class="form-control" id="txt_anio" number="true" required="true" aria-invalid="true" aria-required="true" value="<?php echo $datos['anio'];?>" readonly>
						</div>
                      </div>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input name="txt_color" type="text" class="form-control" id="txt_color" required="true" aria-invalid="true" aria-required="true" value="<?php echo $datos['color'];?>" readonly>
						</div>
                      </div>
                    </div>
					<div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
						  <label class="bmd-label-static">N&deg; Motor (*)</label>
                           <input name="txt_nmotor" type="text" class="form-control" id="txt_nmotor" required="true" aria-invalid="true" aria-required="true" value="<?php echo $datos['num_motor'];?>" readonly>
						</div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-static">N&deg; Chasis (*)</label>
                          <input name="txt_chasis" type="text" class="form-control" id="txt_chasis" required="true" aria-invalid="true" aria-required="true" value="<?php echo $datos['num_chasis'];?>" readonly>
						</div>
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                          ...
                          <input name="file_resolucion" type="text" class="form-control" id="file_resolucion" required="true" aria-invalid="true" aria-required="true" value="<?php echo $datos['resolucion'];?>" readonly>
						</div>
                      </div>
						  <div class="col-md-6">
            ...
            <div class="col-md-4">
              <div class="card card-profile">
               	<?php
					if($datos['imagen']==""){
						 $src="assets/img/car_comparator.png";
					}else{
						$src="vehiculos/".$datos['imagen'];
					}
							?>
				  <input name="file_img" type="hidden" id="file_img" value="<?php echo $datos['imagen'];?>" readonly>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input name="txt_compania" type="text" class="form-control" id="txt_compania" required="true" aria-invalid="true" aria-required="true" value="<?php echo $datos['compania'];?>" readonly>
						</div>
                      </div>
                      </div>
					  <div class="row">
