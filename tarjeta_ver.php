...
$datos=dato_tarjeta($id);

/****opciones para menu****/
$op_principal=13; //Tarjetas Combustibles
$op_secundaria=15; //Editar Tarjeta
/**************************/
?>
<!doctype html>
<html lang="en">
    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#">Ver Tarjeta</a>
          </div>
      ...
      <div class="content">
		<div class="container-fluid">
          <div class="row">
             <div class="col-md-12">
              <form id="TypeValidation" class="form-horizontal" action="tarjeta/edit_tarjeta.php?id=<?php echo encrypt($datos['idtarjeta']);?>" method="post" novalidate="novalidate">
                <div class="card ">
                  ...
                  <div class="card-body ">
                    <div class="row">
                      ...
                      <div class="col-sm-7">
                        <div class="form-group bmd-form-group">
                          <select name="sel_tipo" class="form-control" id="sel_tipo" required="true" aria-invalid="true" aria-required="true" disabled>
								...
								?>
								<option value="<?php echo $row['idtipo_tarjeta'];?>" <?php if($datos['idtipo_tarjeta']==$row['idtipo_tarjeta']) echo "selected";?>><?php echo utf8_encode($row['descripcion']);?></option>
								<?php }?>	
					  		</select>
                        </div>
                      </div>
					...
					<div class="row">
                      ...
                      <div class="col-sm-7">
                        <div class="form-group bmd-form-group">
                         	<input name="txt_empresa" type="text" required="true" class="form-control" id="txt_empresa" aria-invalid="true" aria-required="true" value="<?php echo $datos['empresa'];?>" readonly>
                        </div>
                      </div>
                    </div>    
					<div class="row">
                      ...
                      <div class="col-sm-7">
                        <div class="form-group bmd-form-group">
                         	<input name="txt_num_tarjeta" type="text" required="true" class="form-control" id="txt_num_tarjeta" aria-invalid="true" aria-required="true" value="<?php echo $datos['num_tarjeta'];?>" readonly>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-sm-7">
                        <div class="form-group bmd-form-group">
                          <input name="txt_monto" type="text" class="form-control" id="txt_monto" number="true" required="true" aria-invalid="true" aria-required="true" value="<?php echo $datos['monto_inicial'];?>" readonly>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-sm-7">
                        <div class="form-group bmd-form-group">
						  <?php
							$date = date_create($datos['fecha_vencimiento']);
							$fecha_vencimiento=date_format($date, 'd-m-Y');
							?>		
                          <input name="txt_fvencimiento" type="text" required="true"  class="form-control  datepicker" id="txt_fvencimiento" aria-invalid="true" aria-required="true" value="<?php echo $fecha_vencimiento;?>" readonly/>	
                        </div>
                      </div>
                    </div>
					<div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-7">
                        <div class="form-group bmd-form-group">
                          <input name="txt_responsable" type="text" required="true" class="form-control" id="txt_responsable" aria-invalid="true" aria-required="true" value="<?php echo $datos['responsable'];?>" readonly>
                        </div>
                      </div>
                     </div>
