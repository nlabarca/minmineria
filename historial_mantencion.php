...
$op_secundaria=31; //Historial Mantenciones
/**************************/
?>
<!doctype html>
<html lang="en">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#">Historial Mantenciones</a>
          </div>
					  ...
					  <div class="col-md-4">
                        <div class="form-group bmd-form-group">
                            ...
                            <select name="sel_vehiculos" class="form-control" id="sel_vehiculos" required="true" aria-invalid="true" aria-required="true" onChange="javascript:datos_vehiculo();">
                                ...
                                ?>
                                <option value="<?php echo $row1['idvehiculo'];?>" <?php if($idvehiculo==$row1['idvehiculo']) echo "selected";?>><?php echo $row1['tipo_vehiculo'].'-'.$row1['patente'];?></option>
                                <?php }?>	
                            </select>	
                        </div>
                      </div>	
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary card-header-text">
                  ...
                  <h4 class="card-title">Detalle Mantenciones</h4>
                </div>
                <div class="card-body">
                	<div class="row">
					   <div class="col-md-12">
...
function datos_vehiculo(){
	...
	carga_tabla_mantencion();
}		
function carga_tabla_mantencion(){
	var idvehiculo=$("#sel_vehiculos").val();
	$.ajax({
		type: "POST",
		url: "mantencion/carga_tabla_historial.php?idvehiculo="+idvehiculo,
		data: idvehiculo,
 		beforeSend: function()
		{
    		//$('#loading').show();
