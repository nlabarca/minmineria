      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#">Editar Tarjeta</a>
          </div>
                ...
                <div class="card ">
                  ...
                  <div class="card-body ">
					...
					<div class="row">
                      ...
                      <div class="col-sm-7">
                        <div class="form-group bmd-form-group">
                         	<input name="txt_empresa" type="text" required="true" class="form-control" id="txt_empresa" aria-invalid="true" aria-required="true" value="<?php echo $datos['empresa'];?>">
                        </div>
                      </div>
                    </div>      
                    <div class="row">
                      ...
                      <div class="col-sm-7">
                        <div class="form-group bmd-form-group">
                         	<input name="txt_num_tarjeta" type="text" required="true" class="form-control" id="txt_num_tarjeta" aria-invalid="true" aria-required="true" value="<?php echo $datos['num_tarjeta'];?>">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <label class="col-sm-2 col-form-label">Monto Inicial <span id="obliga">(*)</span></label>
                      <div class="col-sm-7">
                        <div class="form-group bmd-form-group">
                          <input name="txt_monto" type="text" class="form-control" id="txt_monto" number="true" aria-invalid="true" aria-required="true" value="<?php echo $datos['monto_inicial'];?>">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-sm-7">
                        <div class="form-group bmd-form-group">
						  <?php
							...
							?>		
                          <input name="txt_fvencimiento" type="text" required="true"  class="form-control  datepicker" id="txt_fvencimiento" aria-invalid="true" aria-required="true" value="<?php echo $fecha_vencimiento;?>"/>	
                        </div>
                      </div>
                    </div>
					<div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-7">
                        <div class="form-group bmd-form-group">
                          <input name="txt_responsable" type="text" required="true" class="form-control" id="txt_responsable" aria-invalid="true" aria-required="true" value="<?php echo $datos['responsable'];?>">
                        </div>
                      </div>
                     </div>
