      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#">Editar Mantenci&oacute;n</a>
          </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input name="txt_concesionario" type="text" required="true" class="form-control" id="txt_concesionario" aria-invalid="true" aria-required="true" value="<?php echo $datos['concesionario'];?>">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-static">Costo de la manteci&oacute;n (*)</label>
                          <input name="txt_costo" type="text" class="form-control" id="txt_costo" required="true" aria-invalid="true" aria-required="true" value="<?php echo $datos['costo_mantencion'];?>">
						</div>
                      </div>
                      </div>
					  <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
						 ...
						 <?php
						  ...
						  ?>		
    					 <input name="txt_fmantencion" type="text" required="true"  class="form-control  datepicker" id="txt_fmantencion" aria-invalid="true" aria-required="true" value="<?php echo $fecha_mantencion;?>"/>
						</div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input name="txt_kilometraje" type="text" required="true" class="form-control" id="txt_kilometraje" aria-invalid="true" aria-required="true" value="<?php echo $datos['km'];?>">
						</div>
                      </div>
                      </div>
					 <div class="row">
					   <div class="col-md-12">
                    	<div class="form-group">
    						...
    						<div class="form-group bmd-form-group">
                            	<textarea name="txta_detalle" rows="5" class="form-control" id="txta_detalle" required="true" aria-invalid="true" aria-required="true"><?php echo $datos['detalle'];?></textarea>
                          	</div>
						</div>
						</div>
					  </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
    					 ...
    					 <input name="txt_km_prox" type="text" required="true" class="form-control" id="txt_km_prox" aria-invalid="true" aria-required="true" value="<?php echo $datos['km_proxima_mantencion'];?>">
						</div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
						  ...
						  ?>	
                          <input name="txt_fprox_mantencion" type="text" required="true"  class="form-control  datepicker" id="txt_fprox_mantencion" aria-invalid="true" aria-required="true" value="<?php echo $festimada_prox_mantencion;?>"/>	
						</div>
                      </div>
                      </div>
                      <div class="row">
						 <?php if($datos['informe']==""){?>
					   <div class="col-md-6">
                        ...
                        <div class="form-group">
                          ...
                          <input name="file_informe" type="text" class="form-control" id="file_informe" required="true" aria-invalid="true" aria-required="true" value="<?php echo $datos['informe'];?>">
						</div>
                      </div>
						  <div class="col-md-6">
							<div class="input-group">
								...
								<a href="javascript:del_informe('<?php echo encrypt($idmantencion);?>');" class="btn btn-fab btn-round btn-round btn-danger"><i class="material-icons">clear</i></a>	
							</div>
							  </div>
							<?php }?>
					  </div>
