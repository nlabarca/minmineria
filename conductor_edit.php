      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#">Editar Conductor</a>
          </div>
                 	...
                 	<div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input name="txt_nombres" type="text" class="form-control" id="txt_nombres" required="true" aria-invalid="true" aria-required="true" value="<?php echo $datos['nombres'];?>">
						</div>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input name="txt_apellidos" type="text" class="form-control" id="txt_apellidos" required="true" aria-invalid="true" aria-required="true" value="<?php echo $datos['apellidos'];?>">
						</div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                           ...
                           <input name="txt_cargo" type="text" class="form-control" id="txt_cargo" required="true" aria-invalid="true" aria-required="true" value="<?php echo $datos['cargo'];?>">
						</div>
                      </div>
                      <div class="col-md-4">
                      ...
                      <div class="col-md-6">
                        <div class="form-group bmd-form-group">
							<label class="bmd-label-static">Tipo de Licencia (*)</label>
                          	<select name="sel_licencia" class="form-control" id="sel_licencia" required="true" aria-invalid="true" aria-required="true">
								<option selected value="">...</option>
								<?php
                        ...
                        <div class="form-group">
                         <label class="bmd-label-static">Fecha de Vencimiento Licencia (*)</label>
							...
							?>	
    					 <input name="txt_fvencimiento" type="text" required="true"  class="form-control  datepicker" id="txt_fvencimiento" aria-invalid="true" aria-required="true" value="<?php echo $fvencimiento_licencia;?>"/>
						</div>
						 </div>
                    </div>
                    <div class="row">
						 <?php if($datos['docto_licencia']==""){?>
					   <div class="col-md-6">
                    	<div class="form-group form-file-upload form-file-multiple">
				    	  <label class="bmd-label-static">Adjuntar licencia de conducir (*)</label>
							
    						<input name="file_licencia" type="file" multiple="" class="inputFileHidden" id="file_licencia" required="true" aria-invalid="true" aria-required="true">
                        ...
                        <div class="form-group">
                          <label class="bmd-label-static">Adjuntar licencia de conducir (*)</label>
                          <input name="file_licencia" type="text" class="form-control" id="file_licencia" required="true" aria-invalid="true" aria-required="true" value="<?php echo $datos['docto_licencia'];?>">
						</div>
                      </div>
						  <div class="col-md-6">
							<div class="input-group">
								...
								<a href="javascript:del_licencia('<?php echo encrypt($datos['idconductor']);?>');" class="btn btn-fab btn-round btn-round btn-danger"><i class="material-icons">clear</i></a>	
							</div>
							  </div>
							<?php }?>
					  </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input name="txt_compania" type="text" class="form-control" id="txt_compania" required="true" aria-invalid="true" aria-required="true" value="<?php echo $datos['aseguradora'];?>">
						</div>
                      </div>
                      </div>
					  <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-static">Fecha Termino </label>
							...
							?>
                          <input name="txt_ftermino" type="text" class="form-control datepicker" id="txt_ftermino" aria-invalid="true" aria-required="true" value="<?php echo $ftermino_poliza;?>" />
						</div>
                      </div>
                      </div>
					 <div class="row">
                        ...
                        <div class="form-group">
						  ...
						  <div class="col-md-6">
							<div class="input-group">
								...
								<a href="javascript:del_poliza('<?php echo encrypt($datos['idconductor']);?>');" class="btn btn-fab btn-round btn-round btn-danger"><i class="material-icons">clear</i></a>	
							</div>
							  </div>
							<?php }?>
					  </div>
