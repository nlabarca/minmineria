...
<body>
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#">A&ntilde;adir Conductor</a>
          </div>
      ...
      <!-- End Navbar -->
      <div class="content">
		  <form action="conductor/add_conductor.php" method="post" enctype="multipart/form-data" class="form-horizontal" id="TypeValidation" name="TypeValidation" novalidate="novalidate">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
							<label class="bmd-label-static">Rut (*)</label>
						 	<input name="txt_rut" type="text" required="true" class="form-control" id="txt_rut" placeholder="11.111.111-1" onBlur="cargadatos_conductor()" value="<?php echo $datos['rut'];?>" aria-invalid="true" aria-required="true">
						</div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-static">Nombres</label>
                          <input name="txt_nombres" type="text" class="form-control" id="txt_nombres" required="true" aria-invalid="true" aria-required="true">
						</div>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input name="txt_apellidos" type="text" class="form-control" id="txt_apellidos" required="true" aria-invalid="true" aria-required="true">
						</div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                           ...
                           <input name="txt_cargo" type="text" class="form-control" id="txt_cargo" required="true" aria-invalid="true" aria-required="true">
						</div>
                      </div>
                      <div class="col-md-4">
                        ...
                        <div class="form-group bmd-form-group">
							<label class="bmd-label-static">Tipo de Licencia (*)</label>
                          	<select name="sel_licencia" class="form-control" id="sel_licencia" required="true" aria-invalid="true" aria-required="true">
								...
								?>
								<option value="<?php echo $row3['idtipo_licencia'];?>"><?php echo $row3['descripcion'];?></option>
								<?php }?>	
					  		</select>
						</div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input name="txt_ftermino" type="text" class="form-control datepicker" id="txt_ftermino" aria-invalid="true" aria-required="true" />
						</div>
                      </div>
                      </div>
					 <div class="row">
